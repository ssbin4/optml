...
python run_resnet_training_cli.py --path_images ./CARS196/cars_train --path_data ./CARS196/devkit/cars_train_annos.mat --path_labels ./CARS196/devkit/cars_meta.mat --path_model_checkpoint ./checkpoint/ --checkpoint_frequency 50 --model ResNet18 --epochs 200 --validation_frequency 1  --number_of_classes 196 --data_subset 1.0 --batch_size 32 --weight_decay 0.01 --lr_scheduler const  --annealing_factor 0.1 --momentum 0.9 --init_lr 0.0001 --scheduler_rate 10 --no-nesterov --no-freeze_weights --gamma 0.990
date
